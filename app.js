...
function resize(pathInput,outputPath,width){
    sharp(pathInput).resize({width: width}).toFile(outputPath,(erro)=>{
        if(erro){
            console.log(erro);
        }else{
            console.log("Imagem Redimensionada com sucesso,parabens tu é foda")
...
resize(path,'./temp/outputresize.jpg',width);